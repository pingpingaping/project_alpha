										...
										<div id="importExcel" style="display:none;">
											<form action="controller/import_data.php" method="POST" enctype="multipart/form-data">
												<div class="dz-message needsclick download-custom">
													...
													<input type="hidden" name="jenis" value="items">
													<br>
				                                    <h2>Seret File Disini atau Pilih File Import untuk Upload.</h2>
												</div>
                    ...
                    <div class="table-responsive">
                        <table id="data-table-basic" class="table table-striped">
                            ...
                            <tbody>
                            	<?php
                            	$counter = 1;
                            	$result = $connection->query("SELECT * FROM BARANG ORDER BY ID ASC");
                            	...
                            	<tr>
                            		...
                            		<td><a href="transaction-items.php?id=<?php echo $row['ID']; ?>"><button class="btn btn-warning" id="update<?php echo $row['ID']; ?>">Update</button></a></td>
                            	</tr>
                            			<?php
                            			$counter++;
                            		}
                            		...
                            		?>
                            		<tr><td colspan="7"></td>Data Barang Tidak Ada</tr>
                            		<?php
                            	}
                            	?>
                            </tbody>
