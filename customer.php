					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-3">
							<div class="breadcomb-report">
								<a href="transaction-customer.php">
                    ...
                    <div class="table-responsive">
                        <table id="data-table-basic" class="table table-striped">
                            ...
                            <tbody>
                            	<?php
                            	$counter = 1;
                            	$result = $connection->query("SELECT * FROM PELANGGAN ORDER BY ID ASC");
                            	...
                            	<tr>
                            		...
                            		<td><a href="transaction-customer.php?id=<?php echo $row['ID']; ?>"><button class="btn btn-warning" id="update<?php echo $row['ID']; ?>">Update</button></a></td>
                            	</tr>
                            			<?php
                            			$counter++;
                            		}
                            		...
                            		?>
                            		<tr><td colspan="6"></td>Data Pelanggan Tidak Ada</tr>
                            		<?php
                            	}
                            	?>
                            </tbody>
